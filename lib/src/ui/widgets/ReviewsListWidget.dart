...
import 'package:ecommerce_app_ui_kit/src/ui/widgets/ReviewItemWidget.dart';
    ...
    return Consumer<ReviewsList>(
      ...
      value.isLoading()
        ...
        itemBuilder: (context, index) {
          return value.reviewCount() == 0 ? Text(' 😀 بنعتذر المنتج لا يحتوي علي تقييمات ',textAlign: TextAlign.center,style: kStyleTextNoItem,) : ReviewItemWidget(review: value.reviewsList.elementAt(index));
        },
