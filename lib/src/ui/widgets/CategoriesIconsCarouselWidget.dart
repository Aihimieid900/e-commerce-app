...
import 'package:ecommerce_app_ui_kit/src/ui/widgets/CategoryIconWidget.dart';
...
class CategoriesIconsCarouselWidget extends StatefulWidget {
  ...
  CategoriesIconsCarouselWidget({Key key, 
  // this.categoriesList,
   this.heroTag, this.onChanged}) : super(key: key);
